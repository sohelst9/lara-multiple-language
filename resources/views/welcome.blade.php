                        ...
                        <div class="card-header bg-dark d-flex align-item-center justify-content-between">
                            ...
                            <div class="select_language">
                                <select name="language" id="" class="form-control changeLang">
                                    <option value="en" {{ session()->get('locate') == 'en' ? 'selected' : '' }}>
                                        {{ __('data.english') }}</option>
                                    <option value="bn" {{ session()->get('locate') == 'bn' ? 'selected' : '' }}>
                                        {{ __('data.bangla') }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="card-body">
